...
public sealed interface PaymentEvent extends Message {
  record PaymentAuthorized(UUID orderId, UUID paymentId, BigDecimal amount)
  ...
  record PaymentRefunded(UUID orderId, UUID paymentId, BigDecimal amount) implements PaymentEvent {}
}
