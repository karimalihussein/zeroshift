...
public class Reservation extends TableImpl<ReservationRecord> {
     ...
     */
    public final TableField<ReservationRecord, String> REASON = createField(DSL.name("reason"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>public.reservation.created_at</code>.
     */
    public final TableField<ReservationRecord, OffsetDateTime> CREATED_AT = createField(DSL.name("created_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("clock_timestamp()"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "");
    ...
    @Override
    public List<Check<ReservationRecord>> getChecks() {
        return Arrays.asList(
            Internal.createCheck(this, DSL.name("reservation_status_check"), "((status = ANY (ARRAY['RESERVED'::text, 'REJECTED'::text, 'RELEASED'::text])))", true)
        );
    }
